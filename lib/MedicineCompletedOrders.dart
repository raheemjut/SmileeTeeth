...
class MedicineCompleteorder extends StatefulWidget {
  @override
  _MedicineCompleteorderState createState() => _MedicineCompleteorderState();
}

class _MedicineCompleteorderState extends State<MedicineCompleteorder> {
  ...
  List<Spacecraft> filteredorders = List();
   Future<List<Spacecraft>> downloadJSON() async {
    ...
    final response =
        await http.post(ApiUrls.fetchCorders + "?nochache=1", body: {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Medicine Completed Orders'),
      ),
      body: 
              ...
              children: [
                Row(
                  ...
                  Column(
                    ...
                    mainAxisAlignment: MainAxisAlignment.start,
                    children: [
                      Text("Receiver Name: " +filteredorders[index].username,
